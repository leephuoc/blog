    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview @if(isset($active_menu) && $active_menu == 'category') {{'active'}} @endif">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li class="@if(isset($active_sub_menu) && $active_sub_menu == 'create') {{'active'}} @endif"><a href="/admin/category/create"><i class="fa fa-circle-o"></i> Add new </a></li>
                        <li class="@if(isset($active_sub_menu) && $active_sub_menu == 'list') {{'active'}} @endif"><a href="/admin/category/"><i class="fa fa-circle-o"></i> View list</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> View list</a></li>
                    </ul>
                </li>
